...
/*
 id num = [[NSUserDefaults standardUserDefaults] objectForKey:@"kadkkk"];
 
 if (num == nil) {
 [[NSUserDefaults standardUserDefaults] setObject:@"1" forKey:@"kadkkk"];
 ...
 [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"%d",nn] forKey:@"kadkkk"];
 [[NSUserDefaults standardUserDefaults] synchronize];
